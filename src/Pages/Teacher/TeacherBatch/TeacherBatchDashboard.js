...
export const TeacherBatchDashboard = (props) => {
    ...
    return (
        <div>
            ...
            <div>
                <div className='flex border my-5 rounded'>
                    <div onClick={e => setTab('announcement')} id='announcement' className='me-5 p-5 myTab border-b-4 border-primary cursor-pointer bg-slate-100 font-bold'>Announcement</div>
                    <div onClick={e => setTab('people')} id='people' className='me-5 p-5 myTab cursor-pointer'>People</div>
                </div>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherBatchDashboard)